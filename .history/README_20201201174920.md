...
This is the Ruby project #2, from the Microverse's main curriculum and aims to build a myriad of well-known algorithms that are , without using those methods.
