...
This is the Ruby project #2, from the Microverse's main curriculum and aims to build two algorithms similar to the sorting method, without using those methods.
